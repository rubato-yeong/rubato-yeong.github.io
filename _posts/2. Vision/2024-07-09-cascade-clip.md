...
![image](https://github.com/rubato-yeong/rubato-yeong.github.io/assets/78250557/c33a94dc-d8fa-4573-8598-f40d7200bd3d){: .align-center}

또한, DPT(Deep Prompt Tuning)을 통해 CLIP이 추가로 학습되고, 이때 Intermediate Layer도 Mask Optimization에 가담하기 때문에 **Layer 간의 Feature Space가 가까워진 것**을 분석을 통해 알 수 있다.
