...
* [[24' NAACL] Trusting Your Evidence: Hallucinate Less with Context-aware Decoding](https://rubato-yeong.github.io/language/cd-variants/)
  * Input Context를 잘 고려하지 않아 Hallucination이 일어나는 문제를 해결하기 위해 Context가 없는 LM과 대조하여 Context를 증폭시키는 Context-aware Decoding을 제안함
* [[23'] Contrastive Decoding Improves Reasoning in Large Language Models](https://rubato-yeong.github.io/language/cd-variants/)
...
* [[23'] Alleviating Hallucinations of Large Language Models through Induced Hallucinations](https://rubato-yeong.github.io/language/cd-variants/)
